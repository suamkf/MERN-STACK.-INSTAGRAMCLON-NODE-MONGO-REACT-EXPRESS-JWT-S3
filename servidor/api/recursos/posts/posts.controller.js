...
async function guardarImagen(imageData, nombreDelArchivo) {
  ...
  const destinacionDeImagen = `images/${nombreDelArchivo}`
...
/*`https://s3.amazonaws.com/${config.s3BucketName}/${destinacionDeImagen}`;*/
  return `http://${config.s3BucketName}.s3.amazonaws.com/${destinacionDeImagen}`
}
